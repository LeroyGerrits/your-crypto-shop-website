...
describe('ControlPanelCatalogProductPhotoListComponent', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      ...
      imports: [BrowserAnimationsModule, MatIconModule, MatFormFieldModule, MatInputModule, MatMenuModule, MatPaginatorModule, MatSelectModule, MatTableModule, ReactiveFormsModule, RouterLink],
      providers: [
